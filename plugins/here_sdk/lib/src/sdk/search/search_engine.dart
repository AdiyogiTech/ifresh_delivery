...
abstract class SearchEngine implements SearchInterface {
  ...
  /// Returns [TaskHandle]. Handle that will be used to manipulate the execution of the task.
  ///
  @Deprecated("Will be removed in v4.22.0. Please use [SearchInterface.searchByPickedPlace] instead.")
  ...
  /// Returns [TaskHandle]. Handle that will be used to manipulate the execution of the task.
  ///
  @Deprecated("Will be removed in v4.22.0. Please use [SearchInterface.searchByPlaceId] instead.")
  ...
  /// Returns [TaskHandle]. Handle that will be used to manipulate the execution of the task.
  ///
  @Deprecated("Will be removed in v4.22.0. Please use [SearchInterface.suggestByText] instead.")
