...
class ScooterOptions {
  ...
  ScooterOptions._(this.routeOptions, this.textOptions, this.avoidanceOptions, this.tollOptions, this.occupantsNumber, this.maxSpeedOnSegments, this.allowHighway, this.engineSizeInCubicCentimeters);
  ScooterOptions()
...
Pointer<Void> sdkRoutingScooteroptionsToFfi(ScooterOptions value) {
  ...
  final _result = _sdkRoutingScooteroptionsCreateHandle(_routeOptionsHandle, _textOptionsHandle, _avoidanceOptionsHandle, _tollOptionsHandle, _occupantsNumberHandle, _maxSpeedOnSegmentsHandle, _allowHighwayHandle, _engineSizeInCubicCentimetersHandle);
