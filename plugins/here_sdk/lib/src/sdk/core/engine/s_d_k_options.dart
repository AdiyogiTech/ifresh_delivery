...
class SDKOptions {
  ...
  /// Path to be used for storing application internal data which is needed for proper application functionality.
  ...
  /// It is recommented that the application should have exclusive access to this path, so using shared directories such as `Documents` should be avoided.
  ...
  /// Note:
  /// If the [SDKOptions.persistentMapStoragePath] is writable, `data_path` can be left empty.
  /// If the [SDKOptions.persistentMapStoragePath] is not writable, `data_path` must be set and also be writable. Note that data_path is used to store essential SDK data.
  ///
  /// Important:
  /// There is no automatic migration of stored data between the [SDKOptions.persistentMapStoragePath] and the `data_path`. For ease of management,
  /// it's recommended to set the persistence path as writable and ignore `data_path`.
  /// If `data_path` is set differently from the [SDKOptions.persistentMapStoragePath], some data that would typically be saved in the [SDKOptions.persistentMapStoragePath] will now be saved to `data_path`.
  /// If `data_path` is set and later unset, any data stored there will remain inaccessible and will not be migrated back.
  String dataPath;
  ...
  @Deprecated("Will be removed in v4.22.0. Please use [SDKOptions.customEngineOptions] instead")
...
final _sdkCoreEngineSdkoptionsCreateHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, Int64, Pointer<Void>, Pointer<Void>, Pointer<Void>, Uint8, Pointer<Void>, Pointer<Void>, Uint8, Pointer<Void>, Pointer<Void>, Uint32, Pointer<Void>, Pointer<Void>, Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>, Pointer<Void>, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, int, Pointer<Void>, Pointer<Void>, Pointer<Void>)
